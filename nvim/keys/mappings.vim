...
nnoremap <C-s> :w<cr>                      " save files
inoremap <C-d> <esc>:wq!<cr>               " save and exit
nnoremap <C-d> :wq!<cr>                    " save and exit
inoremap <C-q> <esc>:exit<cr>              " quit discarding changes
nnoremap <C-q> :exit<cr>                   " quit discarding changes

inoremap ;; <Esc>                          " Changing Esc bind to ;; for better performance
